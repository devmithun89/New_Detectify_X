     ...
     <>
      ...
      <div class="max-w-xl mx-auto bg-white p-6  box-border  rounded-md shadow-lg">
       <div className='flex justify-end pb-2'>
        <button onClick={clear} className='py-3 px-8 font-Jost font-normal text-base text-white rounded-3xl bg-primary hover:bg-grey duration-500 hover:text-white border-lite.grey border-2 border-solid'>clear</button>
       </div>
